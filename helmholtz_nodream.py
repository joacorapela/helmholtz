...
def main():
    ...
    # plot loss
    printLoss(steps_save, loss_save, filename="fignd/loss.png")

    # plot input
    plt.clf()
    printImageD(aBatch, filename="fignd/inputImage.png")
    ...
    # plot recognition
    plt.clf()
    printLatent(recognition_outputs[-1], filename="fignd/recognitionOutput.png")
